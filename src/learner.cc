...
class LearnerImpl : public Learner {
 public:
  ...
  void Predict(DMatrix* data, bool output_margin,
               ...
               bool pred_leaf, bool pred_contribs, bool approx_contribs, bool pred_gradients) const override {
    if (pred_contribs) {
      gbm_->PredictContribution(data, out_preds, ntree_limit, approx_contribs, pred_gradients);
    } else if (pred_leaf) {
